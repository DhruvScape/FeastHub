      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center px-12 space-y-6">
          ...
          <h1 className="text-4xl font-bold text-primary-foreground">
            Welcome back to FeastHub
          </h1>
          <p className="text-primary-foreground/80 text-lg max-w-md mx-auto">
            Your favorite restaurants are just a few clicks away. Order delicious food delivered right to your door.
          </p>
          <div className="flex justify-center gap-8 pt-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-primary-foreground">500+</div>
              <div className="text-sm text-primary-foreground/70">Restaurants</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-primary-foreground">30 min</div>
              <div className="text-sm text-primary-foreground/70">Avg Delivery</div>
            </div>
          </div>
        </div>
        {/* Decorative circles */}
